...
public:
	...
	inline Memory(Device& device, const ulong N, const uint dimensions = 1u, const bool allocate_host = true, const bool allocate_device = true, const T value = T{}, const bool allow_zero_copy = true) {
...
public:
	...
	inline Kernel& set_ranges_2d(const ulong w, const ulong h, const ulong workgroup_size = (ulong)WORKGROUP_SIZE) {
		this->N = w * h;
		cl_range_global = cl::NDRange(w, h);
		cl_range_local = cl::NDRange(workgroup_size, workgroup_size);
		return *this;
	}
